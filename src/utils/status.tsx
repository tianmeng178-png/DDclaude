...
export function buildAPIProviderProperties(): Property[] {
  ...
  if (apiProvider !== 'firstParty') {
    properties.push({
      label: 'API provider',
      value: getAPIProviderDisplayName()
    });
  }
  if (apiProvider === 'firstParty' || apiProvider === 'compatible') {
    const anthropicBaseUrl = process.env.ANTHROPIC_BASE_URL;
    if (anthropicBaseUrl) {
      properties.push({
        label: apiProvider === 'firstParty' ? 'Anthropic base URL' : 'Anthropic-compatible base URL',
